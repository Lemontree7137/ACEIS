...
public class CSARQLAarhusPollutionStream extends CSPARQLSensorStream implements Runnable {
	...
	public static void main(String[] args) {
		try {
			...
			CSARQLAarhusPollutionStream aps = new CSARQLAarhusPollutionStream("testuri",
	...
	public CSARQLAarhusPollutionStream(String uri, String txtFile, EventDeclaration ed) throws IOException {
		super(uri);
	...
	public CSARQLAarhusPollutionStream(String uri, String txtFile, EventDeclaration ed, Date start, Date end)
			throws IOException {
		super(uri);
	...
	protected SensorObservation createObservation(Object data) {
		try {
			...
			logger.debug(this.getIRI() + ": streaming record @" + po.getObTimeStamp());
