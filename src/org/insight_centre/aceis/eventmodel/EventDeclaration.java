...
public class EventDeclaration implements Cloneable {
	...
	private String httpGrounding;
	private MsgBusGrounding msgBusGrounding;
	...
	public QosVector getExternalQos() throws CloneNotSupportedException, NodeRemovalException {
		if (this.ep == null)
			...
			QosVector compositionQos = this.ep.aggregateQos();
	...
	public String toString() {
		...
		return "ED-" + this.nodeId + " = " + "SrvId:" + this.serviceId + " F:" + this.getInternalFrequency() + "; T:"
				...
				+ " \n " + "http addr: " + this.getHttpGrounding() + "\n " + "message buss grounding: "
				+ this.msgBusGrounding;// +
		// " \n Grounding:"
		// +
		// this.getSrc();
	...
	public String getHttpGrounding() {
		return httpGrounding;
	}

	public void setHttpGrounding(String httpGrounding) {
		this.httpGrounding = httpGrounding;
	}

	public MsgBusGrounding getMsgBusGrounding() {
		return msgBusGrounding;
	}

	public void setMsgBusGrounding(MsgBusGrounding msgBusGrounding) {
		this.msgBusGrounding = msgBusGrounding;
	}
